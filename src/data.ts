...
export const solutionsData = [
  {
    ...
    desc: "Self-directed, adaptive AI agents that make autonomous decisions in real time",
    list: [
...

  {
    ...
    desc: "We don’t give you generic AI; we give you AI that speaks your industry.",
    list: [
...

  {
    ...
    desc: "Seamless integration, security, and support for your IT ecosystem. ",
    list: [
